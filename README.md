...
▶️ Again partitioning are also three types 

▶️ 1) Range bases partitioning 

▶️ 2) List based partitioning 

▶️ 3) Hash based partitioning 

▶️ Sharding 

▶️ Distributed file system for storing videos in databases 

▶️ And all the use cases of all types of partitioning, advantages and disadvantages 
...
▶️ We can use multiple approaches in Asynchronous processing like......
